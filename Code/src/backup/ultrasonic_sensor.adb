...
procedure Main is
   ...
   package sensor3 is new Ultrasonic(MB_P14, MB_P2);
   package sensor4 is new Ultrasonic(MB_P13, MB_P12);
...
begin
   loop
      ...
      Distance := sensor4.Read;
      Put_Line ("Back: " & Distance_cm'Image(Distance)); -- a console line delay the loop significantly
